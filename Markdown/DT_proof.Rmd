...
However, it is now critical to bring to light the following for the reader who has not yet noticed: our set of bets do not conform to Kolmogorov’s probability axiom $P(A\cap, ...,\cap A) = 1$ for a mutually exclusive set of events. As the sum of the bets is
```{r, echo = TRUE}
sum(pi1 + pi2 + pi3)
```
