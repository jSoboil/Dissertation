...
# SUB-MODEL 2: VACCINE-EFFICACY. Note: this is a fully integrated Bayesian model, as it combines
# evidence directly via the likelihood and combines it with a prior. 
